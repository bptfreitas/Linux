...
\renewcommand{\lstlistingname}{Solução}
...
\question[2] Para cada expressão regular abaixo, dê duas strings de exemplo que elas capturam
...
\begin{minipage}{\textwidth}	
\question[2] Quais são os 4 tipos de redirecionamento? O que eles fazem? Cite um exemplo de utilização para cada um deles.
...
\begin{minipage}{\textwidth}		
	\question Explique, sucintamente, o que o seguinte shell script faz:
